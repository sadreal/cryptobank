		...
		<div class="card">
          ...
          <div class="row">
              ...
              <div class="col-md-12 mt-4">
                  <form action="<?php echo e($data->callback_url); ?>?deposit_id=<?php echo e($deposit->id); ?>" method="post" id="payment-form">
                      <?php echo csrf_field(); ?>
                      <div class="form-row">
                          <div id="card-element">
                      ...
                      <div class="form-row">
                          <button class="btn btn-primary btn-block btn-lg" id="pay_now"><?php echo e(_lang('Pay Now')); ?></button>
                      </div>
                  </form>
              </div>
          </div>
...
var stripe = Stripe("<?php echo e($deposit->gateway->parameters->publishable_key); ?>");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/k3lobc2fo9t4/blockchain/resources/views/backend/customer_portal/gateway/Stripe.blade.php ENDPATH**/ ?>