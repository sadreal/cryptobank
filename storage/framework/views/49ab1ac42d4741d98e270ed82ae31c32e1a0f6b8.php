	...
	<div class="col-12">
		<div class="card">
			<div class="card-header d-flex align-items-center">
				<h4 class="header-title"><?php echo e(_lang('Update SMS Template')); ?></h4>
			</div>
			<div class="card-body">
				<form method="post" class="validate" autocomplete="off" action="<?php echo e(action('SMSTemplateController@update', $id)); ?>" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<textarea class="form-control" name="sms_body"><?php echo e($emailtemplate->sms_body); ?></textarea>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<select class="form-control auto-select" name="sms_status" data-selected="<?php echo e($emailtemplate->sms_status); ?>" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/k3lobc2fo9t4/blockchain/resources/views/backend/administration/sms_template/edit.blade.php ENDPATH**/ ?>